...
WEIGHTS = {
    'flow_imagenet_and_kinetics':
        'model/i3d/flow_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels.h5',
    'flow_imagenet_and_kinetics_no_top':
        'model/i3d/flow_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels_no_top.h5',
    'rgb_imagenet_and_kinetics':
        'model/i3d/rgb_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels.h5',
    'rgb_imagenet_and_kinetics_no_top':
        'model/i3d/rgb_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels_no_top.h5',
}
