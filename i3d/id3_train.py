...
train_glob_pattern = 'videos/train/{classname}/*.mp4'
val_glob_pattern = 'videos/test/{classname}/*.mp4'
...
def run_i3d_pretrained():
    EPOCHS = 50
    # with open("msasl/MSASL_classes.json") as f:
    #     classes = json.load(f)
    ...
    m_rgb = add_top_layer(m_rgb, classes=len(classes), dropout_prob=0.5)
